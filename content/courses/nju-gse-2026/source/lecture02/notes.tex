...
\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth,height=0.49\textheight,keepaspectratio]{\detokenize{figures/fig_023_context_competes_attention.jpg}}\\[4pt]
\includegraphics[width=0.5\textwidth]{\detokenize{figures/fig_023_context_competes_attention_board.jpg}}
\caption{上下文既是纠偏资源，也是竞争注意力的资源；下方为同一时刻的板书：从 user 处画回 sys prompt 与此前各段上下文的弧线（原视频画面：00:50:45--00:51:00）}
\end{figure}
